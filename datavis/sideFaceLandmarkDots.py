...
filename = '/media/rob/Ma Book1/alignedCelebFaces/sideImage.jpg'
...
for landmark in face_landmarks[0]:
    ...
    for x in range(xcenter-2,xcenter+2):
        for y in range(ycenter-2,ycenter+2):
            image[y,x] = colors[co]
    co += 1
        

misc.imsave('/media/rob/Ma Book1/alignedCelebFaces/sideImage2.jpg',image)
